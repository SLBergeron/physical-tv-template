        ...
        <div className="mx-auto w-full relative z-20 sm:max-w-[40rem]  md:max-w-[48rem] lg:max-w-[64rem] xl:max-w-[80rem] bg-gradient-to-br from-slate-800 dark:from-neutral-900 to-gray-900 sm:rounded-2xl">
          <div className="relative -mx-6   sm:mx-0 sm:rounded-2xl overflow-hidden px-6  md:px-8 ">
            ...
            <div className="relative px-6 pb-14 pt-20 sm:px-10 sm:pb-20 lg:px-[4.5rem]">
              ...
              <p className="mt-4 max-w-[40rem] text-center mx-auto  text-base/6 text-neutral-200">
                <Balancer>
                  You know where you want to go.
                  <br /><br />
                  You need the right strategy, systems, and story to get there.
                  <br /><br />
                  We help brands turn creative vision into real growth.
                  <br /><br />
                  If you&apos;re ready to make it happen, let&apos;s talk.
                </Balancer>
              </p>

              <div className="relative z-10 mx-auto flex justify-center mt-6">
                <Button as={Link} href="#contact">Start a Conversation</Button>
              </div>
            </div>
          </div>
        </div>
